...
urlpatterns = patterns('roster.views',
    ...
    url(r'^jobs/famjob/(?P<jobid>\w+)$', 'roster_jobs_detail', name='roster_jobs_detail'),
    url(r'^jobs/all/?$', 'roster_jobs_all', name='roster_jobs_all'),
    ...
    # url(r'^signin/?$', 'signin_print', name='signin_print'), # No longer using this
)
