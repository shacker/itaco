def update_profile(sender, instance, signal, created, **kwargs):
    ...
    parent = Parent.objects.get(pk=instance.id)
    ...
    email_subject = render_to_string("tools/profiles/profile_update-subject.txt", { 'p': parent })                    
    email_body_txt = render_to_string("tools/profiles/profile_update-body.txt", { 'p': parent, 'site': site, })        
